...
import com.abduhanifan.dicoding.githubuserapp.alarm.DatePickerFragment
import com.abduhanifan.dicoding.githubuserapp.alarm.TimePickerFragment
import kotlinx.android.synthetic.main.activity_reminder.*
import java.text.SimpleDateFormat
import java.util.*

class ReminderActivity : AppCompatActivity(), View.OnClickListener, DatePickerFragment.DialogDateListener, TimePickerFragment.DialogTimeListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.setTitle(R.string.daily_reminder)
